...
export const CATEGORY_COLORS: Record<PrepositionCategory, string> = {
  [PrepositionCategory.LOCATION]: 'bg-purple-600 hover:bg-purple-500 focus:ring-purple-600 border-purple-500',
  [PrepositionCategory.DIRECTION]: 'bg-teal-600 hover:bg-teal-500 focus:ring-teal-600 border-teal-500',
  [PrepositionCategory.TIME]: 'bg-orange-600 hover:bg-orange-500 focus:ring-orange-600 border-orange-500',
  [PrepositionCategory.MANNER]: 'bg-pink-600 hover:bg-pink-500 focus:ring-pink-600 border-pink-500',
  [PrepositionCategory.CAUSE]: 'bg-red-600 hover:bg-red-500 focus:ring-red-600 border-red-500',
  [PrepositionCategory.POSSESSION]: 'bg-amber-600 hover:bg-amber-500 focus:ring-amber-600 border-amber-500',
  [PrepositionCategory.ACTION_BY]: 'bg-blue-600 hover:bg-blue-500 focus:ring-blue-600 border-blue-500',
};
