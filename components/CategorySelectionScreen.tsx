...
const getCategoryIcon = (category: PrepositionCategory | null) => {
  const iconClass = "w-12 h-12 md:w-14 md:h-14 text-gray-400 group-hover:text-[#EF6035] transition-colors duration-300 drop-shadow-md";
  ...
  switch (category) {
    ...
    case PrepositionCategory.PURPOSE: // Target/Flag
      return (
        <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 21v-8a2 2 0 012-2h14a2 2 0 012 2v8H3zm0 0V5a2 2 0 012-2h14a2 2 0 012 2v8H5" />
